<template>
  <div>
   <!-- <h1 class="my-5 text-center explore__header">Explore Available V-lab Courses</h1> -->
        ...
        <div id="uinfo" class="majorD">
        	<div class="px-5">
        		<br><br>
        		<div class="form-body p-3 bg-white row">
        			<div v-if="student" class="col-lg-6 col-md-6 col-sm-12 d-flex flex-wrap mt-2">
        				<div class="white-space mr-3">Title: </div>
        				<input type="text" name="school" v-model="title" disabled="" class="form-control w-100">        	
        			</div>
                    <div v-else class="col-lg-6 col-md-6 col-sm-12 d-flex flex-wrap mt-2">
                        <div class="white-space mr-3">Matric Number: </div>
                        <input type="text" name="school" v-model="matric_number" disabled="" class="form-control w-100">            
                    </div>
        	...
        	<div class="px-5">
        		...
        		<div class="form-body p-3 bg-white row">
        			<div class="col-lg-12 col-md-12 col-sm-12 d-flex flex-wrap mt-2 position-relative">
        				...
        				<input type="password" :datx="clearDefault()"  name="password" v-model="oldpassword"  class="form-control w-100">        
